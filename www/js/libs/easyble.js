...
//
	...
	*/
	...
	{
		//console.log('easy ble read services'+device.deviceHandle)
		// Read services.
		evothings.ble.services(
			device.deviceHandle,
			function(services)
			{
				//console.log('easy ble read services worked')
	...
	internal.readCharacteristicsForServices = function(device, serviceUUIDs, win, fail)
	{
		...
		var descriptorsCallbackFun = function(characteristic)
		{
			...
			return function(descriptors)
			{
				...
				if(characteristic.__descriptors.length>0){
		...
		else
		{
			...
			//console.log('getting data for all services')
	...
	internal.writeCharacteristic = function(device, characteristicUUID, value, win, fail)
	{
		...
		//console.log('found characteristic'+JSON.stringify(characteristic))
		//console.log('devicehandle'+JSON.stringify(device.deviceHandle))
		//console.log('charhandle'+JSON.stringify(characteristic.handle))
